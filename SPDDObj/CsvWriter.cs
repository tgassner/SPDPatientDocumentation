...
namespace ElencySolutions.CsvHelper
{
    ...
    public sealed class CsvWriter : IDisposable
    {
        ...
        private bool quotesAlways = false;
        ...
        /// <summary>
        /// Gets or sets a value indicating whether [quotes always].
        /// </summary>
        /// <value><c>true</c> if [quotes always]; otherwise, <c>false</c>.</value>
        public bool QuotesAlways {
            get { return quotesAlways;  }
            set { quotesAlways = value; }
        }
        ...
        private void WriteRecord(IList<string> fields, TextWriter writer)
        {
            for (int i = 0; i < fields.Count; i++)
            {
                ...
                writer.Write(string.Format("{0}{1}{0}{2}",
                    (quotesRequired || escapeQuotes || quotesAlways ? "\"" : string.Empty),
                    fieldValue, 
                    ( i < (fields.Count - 1) ? seperator : string.Empty)));
            }
