...
namespace SPD.GUI.Print.HTML {
    class PrintPatientListHtml {
        ...
        private static String onePatient(PatientData patient, ISPDBL patComp, bool useOPData) {
            ...
            if (!useOPData || (operation == null || String.IsNullOrEmpty(operation.Diagnoses))) {
